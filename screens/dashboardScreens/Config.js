      ...
      <ScrollView style={{ backgroundColor: colors.surface1 }}>
        <View style={{ ...styles.container, paddingTop: 10 }}>
          ...
          <Menu
            ...
            anchor={
              <TouchableOpacity onPress={openMenu}>
                <Text style={styles.datePickerInput}>{user.campus}</Text>
              </TouchableOpacity>
            }
          >
            <Menu.Item
          ...
          >
            <SelGradSquare
              color={0}
              style={{ backgroundColor: "#930010" }}
              state={themeConfig.themeIdx}
              setState={setColor}
            />
            <SelGradSquare
              color={1}
            ...
            <SelGradSquare
              color={2}
              style={{ backgroundColor: "#5E3280" }}
              state={themeConfig.themeIdx}
              setState={setColor}
            />
            <SelGradSquare
              color={3}
              style={{ backgroundColor: "#832046" }}
              state={themeConfig.themeIdx}
              setState={setColor}
            />
            <SelGradSquare
    ...
    <>
      ...
      >
        <Text style={styles.textInput}>
          {formatDate(new Date(semester.init))}
        </Text>
      </TouchableOpacity>
      ...
      >
        <Text style={styles.textInput}>
          {formatDate(new Date(semester.end))}
        </Text>
      </TouchableOpacity>
    </>
  );
