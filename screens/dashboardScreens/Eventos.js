...
import { IconButton, useTheme, FAB, Menu, Divider, Surface, Searchbar, Portal, Dialog, Button, Checkbox } from "react-native-paper";
...
export default function SubjectScreen(props) {
    ...
    return (<View style={styles.scroll}>
        ...
        /></View>
        <TouchableOpacity onPress={() => setShowFilter(true)} style={{backgroundColor:colors.surface,alignItems:'center',width:30, 
