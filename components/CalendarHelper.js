...
export function Card(props) {
  ...
  const inicioStr =
    initTime.getHours().toString().padStart(2, "0") +
    "h" +
    initTime.getMinutes().toString().padStart(2, "0");
...
export function compareEvents(a, b) {
  return (
    new Date(a["details"][0]["datetime_init"]) -
    new Date(b["details"][0]["datetime_init"])
  );
}
